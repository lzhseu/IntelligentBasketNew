//
//  LZHSideMenuPresentationStyle.swift
//  IntelligentBasketNew
//
//  Created by 卢卓桓 on 2020/7/13.
//  Copyright © 2020 卢卓桓. All rights reserved.
//

import SideMenu

class LZHSideMenuPresentationStyle: SideMenuPresentationStyle {
    
    required init() {
        super.init()
        /// Background color behind the views and status bar color
        backgroundColor = primaryColor_0_5
